...
const stripe = require("stripe")(
  "sk_test_51HfMCbAziDTXToQ4JqYXnppwAbHoMUf1zodFSht5mBqJ6CjPaHsRXgYoHhEFTzQZLrXWiz0WPZmaFp5bIdHiwOkB00Bzg1G3rb"
);
...
router.get("/shop", function (req, res, next) {
  ...
  if (alreadyExist == false && Object.values(req.query).length > 0) {
